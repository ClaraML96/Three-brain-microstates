...
═══════════════════════════════════════════════════════════════════════════════
Implements `plv-proposal-v2.md`: the FULL cross-brain PLV matrix + the Dumas
...
This first *runnable* version deliberately does NOT depend on it, because:
  ...
  3. It is the CORRECT paired null: a per-triad (friend − non-friend)
     ...
     (`plv-proposal-v2.md` §6.5). HyPyP Fig. 3's "between-condition" shuffle is
...
─────────────────────────────────────────────────────────────────────────────
  ...
  • TWO-SIDED TEST (CLUSTER_TAIL = 0). The directional hypothesis is genuinely
    ...
    sync). Two-sided is the honest default. (Updates v2 §1b's tail=1 assumption.)
  • CONTRAST, NOT ABSOLUTE LEVEL. This tests friend vs non-friend. The cluster
    ...
    already answered (null). See `plv-proposal-v2.md` §0.
...
─────────────────────────────────────────────────────────────────────────────
  ...
  Design: project/05-inter-brain-sync/plv-proposal-v2.md (+ hypyp-decision.md)
─────────────────────────────────────────────────────────────────────────────
"""
...
#     the regression test that links v2's matrix plumbing back to trusted v4.
